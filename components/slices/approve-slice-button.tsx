            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4 py-4">
                        <div className="bg-stone-50 dark:bg-green-950/20 border border-stone-300 dark:border-green-800 rounded-lg p-4">
                        ...
                        {error && (
                            <div className="bg-stone-50 dark:bg-red-950/20 border border-stone-300 dark:border-red-800 rounded-lg p-4">
