...
export function UmarelBrief() {
    ...
    return (
        <section className="py-20 bg-[#fff8f0] border-y border-stone-200/50">
            <div className="container mx-auto px-6">
                <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative order-2 md:order-1 flex justify-center">
                        ...
                        <div className="relative z-10 bg-white p-12 rounded-full shadow-xl border-4 border-stone-200 flex flex-col items-center text-center w-64 h-64 justify-center">
                            <span className="text-8xl mb-4 filter drop-shadow-md">👴</span>
                            <div className="text-sm font-mono text-stone-900 tracking-widest uppercase font-bold mt-2">El Entendido</div>
                        </div>

                        {/* Floating "Hands Behind Back" Icon Concept */}
                        <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-xl shadow-lg border border-stone-200 rotate-12 hidden md:block">
                    ...
                    <div className="order-1 md:order-2 space-y-6">
                        <div>
                            <span className="inline-block px-3 py-1 bg-stone-100 text-stone-900 text-xs font-bold tracking-wider uppercase rounded-full mb-4">
                                {t('subtitle')}
                            </span>
