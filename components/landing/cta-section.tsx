...
export function CtaSection() {
    return (
        <section className="py-24 bg-stone-900 relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute top-0 right-0 w-1/3 h-full bg-white/5 blur-3xl rounded-full" />
            <div className="absolute bottom-0 left-0 w-1/3 h-full bg-white/5 blur-3xl rounded-full" />
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link href="/requests/create">
                        <Button size="lg" className="h-14 px-8 bg-white hover:bg-stone-100 text-stone-900 font-bold w-full sm:w-auto rounded-xl shadow-lg transition-all hover:scale-105">
