...
export function ApprovalActions({ sliceId, amount, currency }: ApprovalActionsProps) {
    ...
    return (
        <Card className="border-stone-300 bg-stone-50/30 dark:border-green-900 dark:bg-green-900/10">
            <CardHeader>
                <CardTitle className="flex items-center gap-2 text-stone-900 dark:text-green-400">
            ...
            <CardFooter className="flex gap-4">
                <Button
                    ...
                    className="w-full bg-stone-900 hover:bg-stone-800 text-white shadow-md transition-all hover:scale-[1.02]"
                ...
                <Button variant="outline" className="text-stone-900 border-stone-300 hover:bg-stone-50 hover:border-red-300">
                    Repo​​rtar Problema
                </Button>
            </CardFooter>
        </Card>
