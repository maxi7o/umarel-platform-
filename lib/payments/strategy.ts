...
export interface PaymentStrategy {
     ...
     */
    createEscrow(sliceId: string, amountCents: number, currency: string, payerId: string, payeeId: string, escrowId: string): Promise<{ transactionId: string, status: string, redirectUrl?: string, clientSecret?: string }>;
